...
start, end = 20240806, 20240830
#start, end = 20240611, 20240611
snow_tmpl_file = f'{pwd}/snow_DS520pdp.TMP.sql' # Snowflake SQL code template (for brand name and start-end dates)
...
bq_output = 'DS520pdp'
create_bq_table.store_bq_DS520(df, bq_output)
