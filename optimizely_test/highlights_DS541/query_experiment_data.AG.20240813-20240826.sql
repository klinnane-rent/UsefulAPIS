...
-- template vars: AG, 2712637656, 20240813, 20240826
--
with variant_list as
(SELECT DISTINCT
    user_pseudo_id userid
        ,CASE WHEN event_params:cd81 LIKE '%824943%' THEN 'Control'
         WHEN event_params:cd81 LIKE '%820970%' THEN 'Variant' end as Variant
    FROM EDW.WEB_ACTIVITY.GA4_EVENT
    WHERE stream_id=2712637656 and (event_date between '20240813' and '20240826')
           AND event_params:cd80 LIKE '%ag_new_highlights%')
