...
start, end = 20240813, 20240826
#start, end = 20240611, 20240611
snow_tmpl_file = f'{pwd}/snow_DS541_Rent.TMP.sql' # Snowflake SQL code template (for brand name and start-end dates)
...
bq_output = 'DS541_Rent'
create_bq_table.store_bq_DS519(df, bq_output)
