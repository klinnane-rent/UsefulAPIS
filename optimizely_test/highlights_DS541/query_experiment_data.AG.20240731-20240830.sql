...
(SELECT DISTINCT
    user_pseudo_id userid
        ,CASE WHEN event_params:cd81 LIKE '%802332%' THEN 'Control'
         WHEN event_params:cd81 LIKE '%802333%' THEN 'Variant' end as Variant
    FROM EDW.WEB_ACTIVITY.GA4_EVENT
    WHERE stream_id=2712637656 and (event_date between '20240731' and '20240830')
           AND event_params:cd80 LIKE '%big_ass_photos_test%')
