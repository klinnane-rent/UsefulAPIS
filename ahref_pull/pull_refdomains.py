...
def getNewLost(domains, retrieve_historics):
    ...
    for domain in domains:
        if retrieve_historics:
            ...
            request = "https://apiv2.ahrefs.com?token=5a94c007693f438ddf4bcd41c4f304ece2df0b8c&target={}.com&limit=1000000000&output=json&from=refdomains_new_lost&mode=subdomains&having=domain_rating%3E%3D20&where=date%3E%3D%22{}%22".format(domain, date_after_equal)
            initial_pull( domain, request, path_append, retrieve_historics)
